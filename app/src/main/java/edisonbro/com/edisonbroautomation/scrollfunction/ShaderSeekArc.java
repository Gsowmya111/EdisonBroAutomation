package edisonbro.com.edisonbroautomation.scrollfunction;

/**
 *  FILENAME: ShaderSeekArc.java
 *  DATE: 07-08-2018

 *  DESCRIPTION:  Class to create seekarc for dimmer.
...
public class ShaderSeekArc extends View {
    ...
    private int mEndColor = 0xFF33B5E5;

    private int[] mColors = new int[]{mStartColor, mEndColor};

    private float[] mPositions = null;

  //org// private int mMarkColor = 0xff64646f;
  private int mMarkColor = 0xff67676f;
    private int mProgressTextColor = 0xff64646f;
  //org // private int mLineColor = 0xffdddddd;
   private int mLineColor = 0xff686868;
    ...
    private void drawText(Canvas canvas) {
        ...
        if (mIsShowProgress) {
            canvas.drawText(String.format("%.0f", mProgress),
                    mCenter - 30 * mMinSize,
                    mCenter,
                    mTextPaint);
        }
