...
/**
 *  FILENAME: SmartDog_Frag.java
 *  DATE: 07-08-2018

 *  DESCRIPTION: Fragment to operate SmartDog Device.
 ...
 *  R1s :  To update response of smartdog in ui
 ...
 * {@link SmartDog_Frag.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SmartDog_Frag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SmartDog_Frag extends Fragment implements TcpTransfer {
    ...
    private static final String TAG1="Smart Dog - ";
    //**********************************************
    int sl;
   ...
   , ServStatus = 3, signallevel = 4, NetwrkType = 5,  MAXUSER = 6, ERRUSER = 7,  UPDATE=8;
     ...
     * @return A new instance of fragment SmartDog_Frag.
     */
    // TODO: Rename and change types and number of parameters
    public static SmartDog_Frag newInstance(String param1, String param2) {
        SmartDog_Frag fragment = new SmartDog_Frag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.smart_dog_frag, container, false);
        btn_on=(Button) view.findViewById(R.id.btnondog);
        btn_off=(Button) view.findViewById(R.id.btnoffdog);
...
try{
    ...
    void transmitdata(String bo) {
        if (Tcp_con.isClientStarted) {


            devno = StaticVariabes_div.smrtdognoa[StaticVariabes_div.smrtdogpst];
            while (devno.length() < 4) devno = "0" + devno;
    ...
    void DataIn(byte[] byt)
    {
        if (byt != null && byt.length == 32) {
            ...
            try{
                ...
                StaticVariabes_div.log("DevType smrtdog"+DevType, TAG1);
                String Dev = inp.substring(4, 8);
                char s14 = inp.charAt(8);
                String DS=String.valueOf(s14);

                StaticVariabes_div.log("DS"+DS+" Devno"+Dev+" devno"+devno, TAG1);

                if(DevType.equals("048")){
                    if(Dev.equals(devno)){

                        if(DS.equals("1"))
                        {
                            StaticVariabes_div.log("smrtdog"+true, TAG1);
