...
/**
 *  FILENAME: Rgb_Frag.java
 *  DATE: 07-08-2018

 *  DESCRIPTION:  Fragment to operate selected rgb Device individually .
 ...
 * {@link Rgb_Frag.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Rgb_Frag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Rgb_Frag extends Fragment implements TcpTransfer {
     ...
     * @return A new instance of fragment Rgb_Frag.
     */
    // TODO: Rename and change types and number of parameters
    public static Rgb_Frag newInstance(String param1, String param2) {
        Rgb_Frag fragment = new Rgb_Frag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.rgb_frag, container, false);
       ...
       // tv_speedval.setTextSize(16.0f);
        ...
        btn_on.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB ON","RGB Shortclick");
        ...
        btn_off.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB OFF","RGB Shortclick");
            }
        })	;
        ...
        btn_Flash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB Flash","RGB Shortclick");
            }
        })	;
        ...
        btn_Strobe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB Strobe","RGB Shortclick");
            }
        })	;
        ...
        btn_Fade.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB Fade","RGB Shortclick");
            }
        })	;
        ...
        btn_Smooth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB Smooth","RGB Shortclick");
            }
        })	;
        ...
        btn_Red.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB Red","RGB Shortclick");
            }
        });
        ...
        btn_Green.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB Green","RGB Shortclick");
            }
        });
        ...
        btn_Blue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB Blue","RGB Shortclick");
            }
        });
        ...
        btn_Pink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB Pink","RGB Shortclick");
            }
        });
        ...
        btn_White.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB White","RGB Shortclick");
            }
        });
        ...
        btn_orange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","RGB Orange","RGB Shortclick");
            }
        });
        ...
        btn_Speedp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","Speed up","Rgb Shortclick");
        ...
        btn_Speedm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Track_button_event("RGB Individual","Speed down","Rgb Shortclick");
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if(rgbstatus) {
                  ...
                  //  rgbvalue.setBackgroundColor(Color.rgb(Color.red(color), Color.green(color), Color.blue(color)));
                    ...
                    Track_button_event("RGB Individual", "Color picker", "Rgb Shortclick");
                }else{
                    Toast.makeText(getActivity(), "please switch on the device first", Toast.LENGTH_SHORT).show();
                }
        ...
        sk.setOnSeekBarChangeListener( new SeekBar.OnSeekBarChangeListener()
        {
            ...
            public void onStopTrackingTouch(SeekBar seekBar)
            {
                if(rgbstatus) {
                    ...
                    Track_button_event("RGB Individual", "Brightness Operation", "Rgb Shortclick");
                }else{
                Toast.makeText(getActivity(), "please switch on the device first", Toast.LENGTH_SHORT).show();
                    sk.setProgress(0);
                 }
...
//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$  TO CHECK INPUT RESPONSE $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    void DataIn(byte byt[])
    {
        ...
        if (byt != null && byt.length == 32) {
            ...
            StaticVariabes_div.log("DS"+DS+"Devno"+Dev+"devno"+devno+"brigval"+brigval+"inp"+inp+"speedval"+speedval, TAG1);
