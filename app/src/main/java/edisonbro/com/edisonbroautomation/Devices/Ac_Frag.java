...
/**
 *  FILENAME: Ac_Frag.java
 *  DATE: 07-08-2018

 *  DESCRIPTION:  Fragment to operate selected ac device individually .
 ...
 * {@link Ac_Frag.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Ac_Frag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Ac_Frag extends Fragment implements TcpTransfer {
    ...
    //*****************************************************************//
    ////////////////////////////////////////////////////
    private static final String TAG1="Ac - ";
     ...
     * @return A new instance of fragment Ac_Frag.
     */
    // TODO: Rename and change types and number of parameters
    public static Ac_Frag newInstance(String param1, String param2) {
        Ac_Frag fragment = new Ac_Frag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.ac_frag, container, false);


        btn_on=(Button) view.findViewById(R.id.btnonac);
        btn_off=(Button) view.findViewById(R.id.btnoffac);
