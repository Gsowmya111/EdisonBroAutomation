 ...
 * {@link SomphtScreen_Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SomphtScreen_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SomphtScreen_Fragment extends Fragment implements TcpTransfer,View.OnClickListener {
    ...
    private static final String TAG1="SomphyScreen frag- ";
    //************************************************************************
    String strtext;
    String strtemp="test";
   ...
   , ServStatus = 3, signallevel = 4, NetwrkType = 5, MAXUSER = 6, ERRUSER = 7,  UPDATE=8;
    ...
    String name ="SomphyScreen Individual";
    //********************************************************************************
    ...
    public static SomphtScreen_Fragment newInstance(String param1, String param2) {
        SomphtScreen_Fragment fragment = new SomphtScreen_Fragment();
    ...
    void transmitdata(int val)
    {
        String str,val4;
        val4=""+val;
        devno=StaticVariabes_div.sompyscrnoa[StaticVariabes_div.sompyscrpst];
