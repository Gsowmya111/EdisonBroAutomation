 ...
 * {@link SwingGate_Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SwingGate_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SwingGate_Fragment extends Fragment implements TcpTransfer,View.OnClickListener {
    ...
    private static final String TAG1="Swing gate frag- ";
    //************************************************************************
    String strtext;
    String strtemp="test";
   ...
   , ServStatus = 3, signallevel = 4, NetwrkType = 5, MAXUSER = 6, ERRUSER = 7,  UPDATE=8;
    ...
    String name ="Swing gate Individual";
    //********************************************************************************
    ...
    public static SwingGate_Fragment newInstance(String param1, String param2) {
        SwingGate_Fragment fragment = new SwingGate_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (Models.valueOf(strtext)) {
            ...
            case SWG1:
                view = inflater.inflate(R.layout.fragment_swing_gate_screen, container, false);
    ...
    public void projscreen_update( final String status ,final  String DevType_num){
        ...
        switch (Models.valueOf(StaticVariabes_div.devtyp)) {
            ...
            case SWG1:
                if(DevType_num.equals("065")){
                    if (status.equals("01")) {
                        b_Open.setBackgroundResource(R.drawable.swing_on_open);
                        b_Close.setBackgroundResource(R.drawable.swing_off_close);
                        b_stop.setBackgroundResource(R.drawable.stop);
                    } else if (status.equals("02")) {
                        b_Close.setBackgroundResource(R.drawable.swing_on_close);
                        b_Open.setBackgroundResource(R.drawable.swing_off_open);
                        b_stop.setBackgroundResource(R.drawable.stop);
    ...
    void transmitdata(int val)
    {
        String str,val4;
        val4=""+val;
        devno=StaticVariabes_div.swingscrnoa[StaticVariabes_div.swingscrpst];
